const config = [
  {
    ...
    data: {
      ...
      socialLinks: {facebook: "https://facebook.com/SpecialMaths", twitter: "https://twitter.com/SpecialMaths", linkedin: "https://www.linkedin.com/company/18048778", youtube: "https://www.youtube.com/channel/UCpiWAm7wFRNzKxG656rlCfw"},
      website: "https://myaurapp.web.app",
      becomemember: "https://meetup.com/GDG-Jalandhar",
      blogs: {medium: "gdg-jalandhar", devto: ""},
      email: "specialmathsacademy@gmail.com",
      hashtags: (4) ["WTMJalandhar", "GDG", "GDGJalandhar", "Aura"],
      teamLink: "/team",
      ...
      meetupLink: "https://drive.google.com/file/d/1IZ-XP_9IgXrqJ6qhqXZe5rNRJZE26Sdw/view?usp=sharing",
    },
  },
  {
    name: 'footer',
    data: {
      links: {
        About: [
          {linktype: "About", link: "dsfdssdfsdf", linkname: "SpecialMaths"}, 
          {linktype: "About", link: "adfs", linkname: "International Math Olympiad"},
          {linkname: "National Mathematical Center", link: "#", linktype: "About"}
        ],
        'Developer Console': [
          {link: "#", linkname: "Something Here", linktype: "Developer Console"},
          {link: "#", linkname: "Something Here", linktype: "Developer Console"},
        ],
        ...
        Resources: [
          ...
          {linktype: "Resources", link: "SomeLinkName", linkname: "Some Link Name"}
        ]
      }
    }
  },
